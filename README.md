...
本项目「水木黑体」为「IPAex ゴシック」和[「霞鹜传承晰黑（霞鹜晰黑2021版）」](https://github.com/lxgw/LxgwXiHei)的衍生字型项目，在原有的字形基础上，将笔画和写法调整为中国大陆地区规范，但保留印刷体特征，如断笔、八屋根等，将大陆黑体中的楷化部分去除，给您一个纯粹的印刷字体。

2023年中，本项目创建，以霞鹜晰黑为基础，将字形改为大陆地区规范，并保留了印刷体特征。由于原本的霞鹜晰黑尚未简化部件的出脚，符合水木字型标准，但是字形并不是特别好看，而后的新版霞鹜晰黑，虽然优化了字形，但简化了出脚，故不采用。本人将一些部件替换为新版晰黑后，确认无误，便发布第一版。由于黑体楷化并不大量影响美观，水木黑体的必要性不大，此后将只专注于水木明体的补字，不再维护水木黑体（如果霞鹜晰黑的出脚回来了，可能会考虑继续跟进）。
...
## 收字情况
重启后首次发布的「霞鹜晰黑」收录「国际表意文字核心」（IICore）范围内的 [9810 个汉字](https://github.com/NightFurySL2001/CJK-character-count/blob/master/iicore-han.txt)。
> #### 何为 IICore？
...
目前「霞鹜晰黑」包含 IICore 所收录的 9810 个常用汉字，以及原始授权字型「IPAex ゴシック」所包含的 JIS 第 1～4 级别汉字，和[「jf 7000 当务字集」](https://justfont.com/jf7000)基本包所收字。水木黑体并没有增加大量的汉字，霞鹜晰黑原有的汉字已经能满足基本需求。
### 后续增字计划？
待定。

## 获取字型
进入 [Releases](https://github.com/enderseven1/Mizuki-Gothic/releases) 页面下载 TTF 格式字型档案。

## 授权资讯
- 本字型在 IPA 所开发并发布的 [IPAex ゴシック](https://moji.or.jp/ipafont/) 基础上衍生，依照 [IPA开放字型授权条款 第1.0版（IPA Font License 1.0）](https://opensource.org/licenses/IPA/) 授权。 使用本字型时，请遵从[「IPA开放字型授权条款 第1.0版」](LICENSE_CHT.md)（[IPA Font License 1.0](LICENSE.md#ipa-font-license-agreement-v10)， [IPAフォントライセンスv1.0](LICENSE.md)）之规定。
